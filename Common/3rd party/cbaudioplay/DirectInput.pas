...
function DIDFT_MAKEINSTANCE(n: Variant) : Cardinal;
function DIDFT_GETTYPE(n: Variant) : Byte;
function DIDFT_GETINSTANCE(n: Variant) : Cardinal;
function DIDFT_ENUMCOLLECTION(n: Variant) : Cardinal;
function DIMAKEUSAGEDWORD(UsagePage, Usage: Word) : Cardinal;
...
function joyConfigChanged(dwFlags : Cardinal) : MMRESULT; stdcall;

var

  DirectInputCreateA  : function (hinst : THandle; dwVersion : Cardinal; out ppDI : IDirectInputA; punkOuter : IUnknown) : HResult; stdcall;
  DirectInputCreateW  : function (hinst : THandle; dwVersion : Cardinal; out ppDI : IDirectInputW; punkOuter: IUnknown) : HResult; stdcall;
  DirectInputCreate   : function (hinst : THandle; dwVersion : Cardinal; out ppDI : IDirectInput; punkOuter: IUnknown) : HResult; stdcall;

  DirectInputCreateEx : function (hinst : THandle; dwVersion : Cardinal; const riidltf : TGUID; out ppvOut; punkOuter : IUnknown) : HResult; stdcall;
...
function joyConfigChanged(dwFlags : Cardinal) : MMRESULT; external 'WinMM.dll';
...
{$IFDEF DIRECTX8}
    ...
    DirectInput8Create := GetProcAddress(DInput8DLL, 'DirectInput8Create');
