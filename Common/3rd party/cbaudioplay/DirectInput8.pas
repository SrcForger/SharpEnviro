...
{$IFNDEF STATIC_LINKING}
var DirectInput8Create : function (hinst : THandle; dwVersion : LongWord; const riidltf : TGUID; out ppvOut; punkOuter : IUnknown) : HResult; stdcall;
{$ELSE}
function DirectInput8Create(hinst : THandle; dwVersion : LongWord; const riidltf : TGUID; out ppvOut; punkOuter : IUnknown) : HResult; stdcall;
{$ENDIF}
...
function DirectInput8Create(hinst : THandle; dwVersion : LongWord; const riidltf : TGUID; out ppvOut; punkOuter : IUnknown) : HResult; stdcall; external DI8DLLName name 'DirectInput8Create';
{$ENDIF}
...
begin
  ...
  begin
    DInput8DLL := LoadLibrary(DI8DLLName);
    if DInput8DLL <> 0 then
      DirectInput8Create := GetProcAddress(DInput8DLL, 'DirectInput8Create')
    else DirectInput8Create := nil;
  end;
end;
