...
var
  VKeyArray: array[0..255] of string = ('VK_NONE', 'VK_LBUTTON', 'VK_RBUTTON', 'VK_CANCEL',
    ...
    'VK_LSHIFT', 'VK_RSHIFT', 'VK_LCONTROL', 'VK_RCONTROL', 'VK_LMENU', 'VK_RMENU', 'VK_BROWSER_BACK',
    ...
    'VK_LAUNCH_MAIL', 'VK_LAUNCH_MEDIA_SELECT', 'VK_LAUNCH_APP1', 'VK_LAUNCH_APP2', 'VK_UNKNOWN184', 'VK_UNKNOWN185',
