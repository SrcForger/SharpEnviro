...
type
  ...
  private
    ...
    procedure CalcButtonLayout(Canvas: TCanvas; ABitmap32: TBitmap32; const
      Client: TRect; Pressed, Down: Boolean; const Caption: string; Layout:
      TButtonLayout; Margin, Spacing: Integer; var GlyphPos, TextPos: TPoint;
      BiDiFlags: LongInt);
...
procedure TSharpEPanel.CalcButtonLayout(Canvas: TCanvas; ABitmap32:
  TBitmap32; const Client: TRect; Pressed, Down: Boolean; const Caption: string;
  Layout: TButtonLayout; Margin, Spacing: Integer; var GlyphPos, TextPos:
    TPoint;
  BiDiFlags: LongInt);
var
...
begin
  ...
  if ABitmap32 <> nil
    then
    GlyphSize := Point(ABitmap32.Width, ABitmap32.Height)
  else
    GlyphSize := Point(0, 0);
