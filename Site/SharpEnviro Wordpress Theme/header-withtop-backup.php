				...
				<dl>
					<dd>
	                                  <?php if ( is_user_logged_in() ):  ?>
                                            <dd>Welcome <?php $current_user = wp_get_current_user(); echo $current_user->display_name; ?>:</dd>
                                            <dd><a href="wp-admin/profile.php">Profile</a></dd><dd><a href="<?php echo wp_logout_url(); ?>">Logout</a>
                                          <?php else: ?>  
                                            <dd><a href="<?php echo wp_login_url(); ?>?action=register">Register</dd><dd></a> <a href="<?php echo wp_login_url(); ?>">Login</a>
                                          <?php endif; ?>
					</dd>
		...
		<div class="wrapper">
			...
			<div id="navigation">
				<ul id="nav">
					...
					<li class="page_item <?php if (($title == 'About')) echo('current_page_item');?>"><a href="http://www.sharpenviro.com/wp/?page_id=2">About</a></li>
					<li class="page_item <?php if (is_front_page()) echo( 'current_page_item');?>"><a href="<?php bloginfo( 'url'); ?>"><?php _e( 'News', 'titan' ); ?></a></li>
