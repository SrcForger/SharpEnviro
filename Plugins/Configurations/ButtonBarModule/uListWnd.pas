...
uses
  ...
  SharpEListBoxEx, ButtonBarList, SharpIconUtils, GR32, ExtCtrls, SharpApi, SharpCenterApi;
...
type
  ...
  private
    ...
    procedure SetBarId(const Value: integer);
  ...
  public
    ...
    property BarId: integer read FBarId write SetBarId;
...
procedure TfrmList.SetBarId(const Value: integer);
begin
  FBarId := Value;
  FItems.BarId := Value;
end;

procedure TfrmList.SetModuleId(const Value: integer);
begin
  FModuleId := Value;
  FItems.ModuleId := Value;
end;
