object frmEditScheme: TfrmEditScheme
  ...
  object vals: TJvValidators
    ...
    Left = 12
    Top = 8
    object valSchemeName: TJvRequiredFieldValidator
      Valid = True
      ControlToValidate = edName
      PropertyToValidate = 'Text'
      Enabled = True
      ErrorMessage = 'Scheme name can not be blank'
    end
    object valSchemeUnique: TJvCustomValidator
      Valid = True
      ControlToValidate = edName
      PropertyToValidate = 'Text'
      Enabled = True
      ErrorMessage = 'Scheme name must be unique'
      OnValidate = valSchemeUniqueValidate
    end
    object valAuthor: TJvRequiredFieldValidator
      Valid = True
      ControlToValidate = edAuthor
      PropertyToValidate = 'Text'
      Enabled = True
      ErrorMessage = 'Author must not be blank'
    end
    object valSchemeNameInvalidChars: TJvCustomValidator
      Valid = True
      ControlToValidate = edName
      PropertyToValidate = 'Text'
      Enabled = True
      ErrorMessage = 'Scheme names can not include invalid characters'
      OnValidate = valSchemeNameInvalidCharsValidate
    end
  end
  object err: TJvErrorIndicator
