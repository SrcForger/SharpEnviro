...
begin
  ...
  tmpItemData := TAppBarItem(AItem.Data);
...
begin
    ...
    if lbItems.ItemIndex <> -1 then
      selectedIndex := TAppBarItem(lbItems.Item[lbItems.ItemIndex].Data).Id
    else
      selectedIndex := -1;
    ...
    for i := 0 to FItems.Count - 1 do begin
      ...
      tmpItemData := TAppBarItem(FItems.Items[i]);
...
begin
  ...
  for i := 0 to Pred(lbItems.Count) do begin
      ...
      tmpItemData := TAppBarItem(lbItems[i].Data);
