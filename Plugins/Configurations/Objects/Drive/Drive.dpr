{
Source Name: Drive
Description: Drive Object Config Dll
...
//  VCLFixPack,
  ...
  uISharpETheme,
  DriveObjectXMLSettings in '..\..\..\Objects\Drive\DriveObjectXMLSettings.pas',
...
begin
  ATabItems.AddObject('Drive', frmSettings.pagDrive);
...
var
  ...
  n: integer;
begin
  xmlSettings := TXMLSettings.Create(strtoint(PluginHost.PluginId), nil, 'Drive');
  try
...
begin
  ...
  begin
    Name := 'Drive';
    Description := 'Drive Object Configuration';
...
begin
  ...
  begin
    Name := 'Drive';
    Description := 'The Drive object shows the selected drive on your desktop';
    Status := '';
  end;
end;
