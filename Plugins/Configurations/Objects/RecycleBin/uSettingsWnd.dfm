    ...
    object pagLink: TJvStandardPage
      ...
      object pnlLink: TPanel
        ...
        object SharpECenterHeader2: TSharpECenterHeader
          ...
          Margins.Right = 5
          Margins.Bottom = 10
          Title = 'Empty Recycle Bin Icon'
          Description = 'Define which icon to dispay when the Recycle Bin is empty'
          TitleColor = clWindowText
          DescriptionColor = clRed
          Align = alTop
        end
        ...
        object Panel3: TPanel
          ...
          object edtRecycleBinFull: TEdit
            Left = 0
            Top = 0
            Width = 403
            Height = 22
        ...
        object SharpECenterHeader18: TSharpECenterHeader
          ...
          Margins.Right = 5
          Margins.Bottom = 10
          Title = 'Full Recycle Bin Icon'
          Description = 'Select which icon to dispay when the Recycle Bin is full'
          TitleColor = clWindowText
          DescriptionColor = clRed
          Align = alTop
        end
        object Panel4: TPanel
          ...
          object edtRecycleBinEmpty: TEdit
            Left = 0
            Top = 0
            Width = 403
            Height = 22
