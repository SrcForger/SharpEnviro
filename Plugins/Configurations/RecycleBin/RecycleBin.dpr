...
begin
  ATabs.AddObject('RecycleBin',frmRecycleBin.pagRecycleBin);
  ATabs.AddObject('Icon',frmRecycleBin.pagIcon);
  ATabs.AddObject('Font',frmRecycleBin.pagFont);
  ATabs.AddObject('Font Shadow',frmRecycleBin.pagFontShadow);
end;
