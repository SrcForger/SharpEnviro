...
{$ENDIF}
  ...
  IDirect3DRMMeshBuilder3 = interface (IDirect3DRMVisual)
    ...
    function AddMeshBuilder (lpD3DRMMeshBuild: IDirect3DRMMeshBuilder; flag : DWORD) : HResult; stdcall;    function AddFrame (lpD3DRMFrame: IDirect3DRMFrame3) : HResult; stdcall;
    ...
    function CreateMesh (out lplpD3DRMMesh: IDirect3DRMMesh) : HResult; stdcall;
    function GetFace
        (dwIndex: DWORD; out lplpD3DRMFace: IDirect3DRMFace) : HResult; stdcall;
