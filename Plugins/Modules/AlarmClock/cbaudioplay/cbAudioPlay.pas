...
uses
  ...
  DirectShow, Dialogs, ActiveX, ComObj;
...
type
  ...
  private
    ...
    procedure WaitForState(State: TFilter_State);
  ...
  public
    ...
    property State: TFilter_State read FState;
...
procedure DeleteMediaType(mt: PAM_MEDIA_TYPE);
begin
...
procedure TcbAudioPlay.WaitForState(State: TFilter_State);
var
  lfs: TFilter_State;
begin
