...
type
  ...
  TDebugWndClass = class of TDebugWnd;

var
  DebugWndClass: TDebugWndClass = TDebugWnd;
...
begin
  if JclValidateModuleAddress(ExceptAddr)
    ...
    TDebugWnd.ExceptionHandler(nil, Exception(ExceptObject))
  else
    SysUtils.ShowException(ExceptObject, ExceptAddr);
end;
...
procedure TDebugWnd.AfterCreateDetails;
begin
...
procedure TDebugWnd.BeforeCreateDetails;
begin
...
function TDebugWnd.ReportMaxColumns: Integer;
begin
  Result := 78;
end;
...
procedure TDebugWnd.SendBtnClick(Sender: TObject);
begin
...
procedure TDebugWnd.CopyReportToClipboard;
begin
...
procedure TDebugWnd.CreateDetails;
begin
...
procedure TDebugWnd.CreateReport;
var
  SL: TStringList;
  I: Integer;
...
procedure TDebugWnd.DetailsBtnClick(Sender: TObject);
begin
...
class procedure TDebugWnd.ExceptionHandler(Sender: TObject; E: Exception);
begin
...
class procedure TDebugWnd.ExceptionThreadHandler(Thread: TJclDebugThread);
begin
  if ExceptionShowing then
  begin
...
procedure TDebugWnd.FormCreate(Sender: TObject);
begin
...
procedure TDebugWnd.FormDestroy(Sender: TObject);
begin
...
procedure TDebugWnd.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TDebugWnd.FormPaint(Sender: TObject);
begin
...
procedure TDebugWnd.FormResize(Sender: TObject);
begin
...
procedure TDebugWnd.FormShow(Sender: TObject);
begin
  BeforeCreateDetails;
...
function TDebugWnd.GetReportAsText: string;
begin
...
procedure TDebugWnd.NextDetailBlock;
begin
...
function TDebugWnd.ReportNewBlockDelimiterChar: Char;
begin
  Result := '-';
end;
...
procedure TDebugWnd.SetDetailsVisible(const Value: Boolean);
var
...
class procedure TDebugWnd.ShowException(E: TObject; Thread: TJclDebugThread);
begin
  if WndDebug = nil then
    WndDebug := TDebugWndClass.Create(Application);
  try
    with WndDebug do
    begin
...
procedure TDebugWnd.UMCreateDetails(var Message: TMessage);
begin
  Update;
  CreateDetails;
end;
...
procedure TDebugWnd.UpdateTextLabelScrollbars;
begin
...
begin
  ...
  begin
    ...
    AppEvents.OnException := TDebugWnd.ExceptionHandler;
    ...
    JclDebugThreadList.OnSyncException := TDebugWnd.ExceptionThreadHandler;
